    ...
    <>
      <div className="nw-page">
        ...
        <section className="nw-hero">
          <img
            className="nw-hero__photo"
            src={IMG.earthAtNight}
            alt=""
            role="presentation"
            loading="eager"
            fetchpriority="high"
        ...
        {/* ORBIT VISUAL */}
        <section className="nw-orbit-section">
          <img className="nw-orbit-section__photo" src={IMG.nebula} alt="" role="presentation" loading="lazy" />
          <div className="nw-orbit-section__scrim" aria-hidden="true" />
          <div className="nw-section nw-orbit-section__inner">
        ...
        {/* COVERAGE ZONES */}
        <section className="nw-zones-section">
          <img className="nw-zones-section__photo" src={IMG.milkyWay} alt="" role="presentation" loading="lazy" />
          <div className="nw-zones-section__scrim" aria-hidden="true" />
          <div className="nw-section nw-zones-section__inner">
        ...
        {/* LIVE STATION TABLE */}
        <section className="nw-status-section">
          <img className="nw-status-section__photo" src={IMG.serverCables} alt="" role="presentation" loading="lazy" />
          <div className="nw-status-section__scrim" aria-hidden="true" />
          <div className="nw-section nw-status-section__inner">
            <Reveal className="nw-section__head">
        ...
        <section className="nw-cta">
          <img className="nw-cta__photo" src={IMG.dishField} alt="" role="presentation" loading="lazy" />
          <div className="nw-cta__scrim" aria-hidden="true" />
          <Reveal className="nw-cta__inner">
